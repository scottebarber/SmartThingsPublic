...
/*
	...
	def paramsArm = [
		...
		body: [SessionID: token, LocationID: locationId, DeviceID: deviceId, ArmType: 0, UserCode: '7897']
	]
...
def armStay() {		   
	...
	def paramsArm = [
		uri: "https://rs.alarmnet.com/TC21API/TC2.asmx/ArmSecuritySystem",
		body: [SessionID: token, LocationID: locationId, DeviceID: deviceId, ArmType: 1, UserCode: '7897']
	]
	def metaData = panelMetaData(token, locationId) // Gets AlarmCode
...
def disarm() {
	...
	def paramsDisarm = [
		...
		body: [SessionID: token, LocationID: locationId, DeviceID: deviceId, UserCode: '7897']
	]
	def metaData = panelMetaData(token, locationId) // Gets AlarmCode
